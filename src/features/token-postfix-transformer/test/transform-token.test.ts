...
describe('tokenizeAndTrasfrom-postfix test', () => {
    test('number', () => {
        const actual = tokenizeAndTrasfrom('1 + 2 - 3');
        const expected = [
    ...
    test('number with precedence', () => {
        const actual = tokenizeAndTrasfrom('1 + 2 * 3 % 5');
        const expected = [
            Tokens.number('1', { position: 0, size: 1 }),
            Tokens.number('2', { position: 4, size: 1 }),
            Tokens.number('3', { position: 8, size: 1 }),
    ...
    test('string', () => {
        const actual = tokenizeAndTrasfrom('"hello" + \'world\'');
        const expected = [
    ...
    test('function', () => {
        const actual = tokenizeAndTrasfrom('function()');
        const expected = [
    ...
    test('function with args', () => {
        const actual = tokenizeAndTrasfrom('function(1, 2 + 3)');
        const expected = [
            Tokens.identifier('function', { position: 0, size: 8 }),
            Tokens.param(),
    ...
    test('sum with function', () => {
        const actual = tokenizeAndTrasfrom('sum(1, 2) + 3');
        const expected = [
    ...
    test('indexor 0', () => {
        const actual = tokenizeAndTrasfrom('array[0]');
        const expected = [
    ...
    test('indexor 1', () => {
        const actual = tokenizeAndTrasfrom('array[i + 1]');
        const expected = [
            Tokens.identifier('array', { position: 0, size: 5 }),
    ...
    test('chain 1', () => {
        const actual = tokenizeAndTrasfrom('data.get()');
        const expected = [
    ...
    test('chain 2', () => {
        const actual = tokenizeAndTrasfrom('data.get()[1][2]');
        const expected = [
            Tokens.identifier('data', { position: 0, size: 4 }),
            Tokens.identifier('get', { position: 5, size: 3 }),
            Tokens.operator('.', { position: 4, size: 1 }),
